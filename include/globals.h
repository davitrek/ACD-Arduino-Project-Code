...
#define POWERTRAIN_SPEED_PIN 5
#define POWERTRAIN_FOR_PIN 10
#define POWERTRAIN_REV_PIN 9
...
#define CRANERAISE_SPEED_PIN 3
#define CRANERAISE_FOR_PIN 2
#define CRANERAISE_REV_PIN 4
#define CRANERAISE_SPEED 100
#define CRANERAISE_TIME 5000

#define CRANEDELIVER_SPEED_PIN 3
#define CRANEDELIVER_FOR_PIN 7
#define CRANEDELIVER_REV_PIN 8
#define CRANEDELIVER_SPEED 100
#define CRANEDELIVER_TIME 5000

#define USONIC_TRIG_PIN 11
#define USONIC_ECHO_PIN 6
#define USONIC_REPEAT_AMOUNT 3
#define USONIC_OBSTACLE_DISTANCE_MAX 50

#define IRSENSOR_PIN 6
